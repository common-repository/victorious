					...
					if (!$tb.eq(k).hasClass(c.cssInfoBlock)) {
						...
						for (i = 0; i < totalRows; ++i) {
							...
							for (j = 0; j < c.columns; ++j) {
                                ...
                                // for sport.guru 
//                                if (j == 4) {
//                                    var new_str = t.toString();
//                                    if (new_str.indexOf('M') != -1) {
//                                        var value_info = new_str.split("M");
//                                        var new_salary = parseFloat(new_str) * 1000000;
//                                        var new_value = new_salary.toString() + value_info[1];
//                                        t = new_value;
//
//                                    }
//                                }
