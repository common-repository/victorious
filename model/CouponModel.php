...
class VIC_CouponModel
{
    ...
    {
        global $wpdb;
        $table_name = $wpdb->prefix.'vccp_coupon';
    ...
    public function isCouponCodeUsed($coupon_code, $action_type)
    {
        ...
        if($coupon != null)
        {
            $table_name = $wpdb->prefix.'vccp_coupon_used';
    ...
    public function getCouponList($aConds, $sSort = null, $iPage = '', $iLimit = '')
    {
        ...
        global $wpdb;
        $tableName = $wpdb->prefix.'vccp_coupon';	
    ...
    {
        global $wpdb;
        return $wpdb->insert($wpdb->prefix.'vccp_coupon_used', array('coupon_id' => $coupon_id, 
                                                                'user_id' => $user_id,
