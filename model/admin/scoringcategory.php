...
class VIC_ScoringCategory extends VIC_Model
{
    ...
    public function getScoringCategoryByFilter($sport_id, $aConds, $sSort = 'id DESC', $iPage = '', $iLimit = '')
    {
