<?php
class VIC_TablePlayerPosition extends WP_List_Table
{
    ...
    function column_default( $item, $column_name )
    {
        switch( $column_name )
        {
            ...
            case 'edit':
                return sprintf('<a href="?page=%s&action=%s&id=%s">Edit</a>', 'add-playerposition','edit',esc_html($item['id']));
            default:
    ...
    function prepare_items($keyword = null) 
    {
        ...
        //get data
        list($total_items, $aResults) = self::$playerposition->getPlayerPositionByFilter($aCond, 'id DESC', ($this->get_pagenum() - 1) * $item_per_page, $item_per_page);
