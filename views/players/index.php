<div class="wrap vc-wrap">
    ...
    <h2>
        ...
        <?php echo esc_html(__("Manage Players", 'victorious'));?>
    ...
    <form name="adminForm" action="<?php echo esc_url(self::$url);?>" method="post">
        ...
        <input type="button" value="<?php echo esc_html(__("Delete Selected", "victorious"));?>" class="vc-button btn-red btn-size-sm btn-radius5 mt-3"  onclick="return jQuery.admin.action('', 'delete');">
        <input type="button" value="<?php echo esc_html(__("Save Changes", "victorious"));?>" class="vc-button btn-green btn-size-sm btn-radius5 mt-3"  onclick="return jQuery.admin.action('', 'save');">
