    ...
    <div class="stats-cont" ng-hide="!dataLoaded" style="display: block;"> 
        <div class="skaters-wrapper">
            ...
            <?php if($playerstats != null):?>
                        ...
                        <thead class="bottom-header ng-scope">
                            <tr class="ng-scope">
                                ...
                                <?php if($scoring_categories != null): ?>
                                    ...
                                    <th class="header sortable <?php echo esc_attr($sort_by == $scoring_category['sort_key'] ? "current_sortable" : "");?>" title="<?php echo esc_attr($scoring_category['name']);?>" data-sortby="<?php echo esc_attr($scoring_category['sort_key']);?>" data-sorttype="<?php echo esc_attr($sort_by == $scoring_category['sort_key'] && $sort_type != "" ? $sort_type : "");?>">
                ...
                <?php if($playerstats != null && $total_pages > 1):?>
