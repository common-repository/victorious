    ...
    <div class="vc-section">
        <div class="p-4">
            ...
            <div class="vc-table-small" id="vc-leaderboard">
                <?php $active_row = 0; require_once(VICTORIOUS__PLUGIN_DIR_VIEW_ELEMENT."portfolio/leaderboard.php");?>
            </div>
        </div>
        <div id="vc-leaderboard-detail">
            <?php require_once(VICTORIOUS__PLUGIN_DIR_VIEW_ELEMENT."portfolio/leaderboard_detail.php");?>
        </div>
    </div>
</article>
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        jQuery.portfolio.initPortfolioResult();
    })
</script>