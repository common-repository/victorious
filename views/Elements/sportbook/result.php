                ...
                <div class="vc-section">
                    <div class="p-4">
                        ...
                        <div class="vc-table-small" id="vc-leaderboard">
                            <?php require_once(VICTORIOUS__PLUGIN_DIR_VIEW_ELEMENT."sportbook/leaderboard.php");?>
                        </div>
                    </div>
                    <div id="vc-leaderboard-detail">
                        <?php require_once(VICTORIOUS__PLUGIN_DIR_VIEW_ELEMENT.'sportbook/leaderboard_detail.php');?>
                    </div>
                </div>
            </article>
        </div>
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        jQuery.sportbook.initSportbookResult();
    })
</script>