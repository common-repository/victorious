                    ...
                    <tr>
                        <td style="text-align:center;width:30%">
                            ...
                            <?php if(!empty($aFight['full_image_path1'])):?>
                                <img src="<?php echo esc_attr($aFight['full_image_path1']);?>" style="height:80px" />
                            <?php endif;?>
                            <br><?php echo esc_html(__("H:", "victorious"))." ".esc_html($aFight['name1']);?>
                            <br>&nbsp;
                        ...
                        <td style="text-align:center;width:30%">
                            ...
                            <?php if(!empty($aFight['full_image_path2'])):?>
                                <img src="<?php echo esc_attr($aFight['full_image_path2']);?>" style="height:80px" />
                            <?php endif;?>
                            <br><?php echo esc_html(__("A:", "victorious"))." ".esc_html($aFight['name2']);?>
                            <br>&nbsp;
                        ...
                        <td style="text-align:center;vertical-align: middle">
                            ...
                            <?php if(!empty($aRounds)):?>
                                <br>
                                <br>
                                <select id="round<?php echo esc_attr($aFight['fightID']);?>" class="form-control" name="round<?php echo esc_attr($aFight['fightID']);?>" style="width:205px" <?php if($aFight['started'] == 1):?>disabled="true"<?php endif;?>>
                            ...
                            <?php endif;?>
                            <?php if(!empty($aMinutes)):?>
                                <br>
                                <br>
                                <select onchange="checkMinute(this.value,<?php echo esc_attr($aFight['fightID']);?>)" class="form-control minute" data-id="<?php echo esc_attr($aFight['fightID']);?>" id="minute<?php echo esc_attr($aFight['fightID']);?>" name="minute<?php echo esc_attr($aFight['fightID']);?>" style="width:205px" <?php if($aFight['started'] == 1):?>disabled="true"<?php endif;?>>
            ...
            <table border="0" class="table table-striped table-bordered table-responsive table-condensed">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;vertical-align: middle;border: none;">   <br><?php echo VIC_DateTranslate($aFight['startDate']);?></td>
                    ...
                    <tr>
                            ...
                            <label>
                                <?php if(!empty($aFight['full_image_path1'])):?>
                                    <div class="team_image">
                                        <img src="<?php echo esc_attr($aFight['full_image_path1']);?>" />
                                    </div>
                                <?php endif;?>
                                <br>
                                <?php echo esc_html(__("H:", "victorious"))." ".esc_html($aFight['name1']);?>
                                <br>&nbsp;
                                <input type="radio" class="fightID" value="<?php echo esc_attr($aFight['fighterID1']);?>" name="winner<?php echo esc_attr($aFight['fightID']);?>" data-fightid="<?php echo esc_attr($aFight['fightID']);?>" <?php if($aFight['winnerID'] == $aFight['fighterID1']):?>checked="checked"<?php endif;?> <?php if($aFight['started'] == 1):?>disabled="true"<?php endif;?>>
                            </label>
                        </td>
                        <td style="text-align:center;vertical-align: middle">
                            ...
                            <br><input type="radio" class="fightID" value="0" name="winner<?php echo esc_attr($aFight['fightID']);?>" data-fightid="<?php echo esc_attr($aFight['fightID']);?>" <?php if($aFight['winnerID'] ===0):?>checked="checked"<?php endif;?> <?php if($aFight['started'] == 1):?>disabled="true"<?php endif;?>>
                            <?php else: ?>
                            <br> VS
                             <br><?php echo VIC_DateTranslate($aFight['startDate']);?>
                            <?php endif; ?>
                        ...
                        <td style="text-align:center;width:30%">
                            ...
                            <label>
                                <?php if(!empty($aFight['full_image_path2'])):?>
                                    <div class="team_image">
                                        <img src="<?php echo esc_attr($aFight['full_image_path2']);?>" />
                                    </div>
                                <?php endif;?>
                                <br>
                                <?php echo esc_html(__("A:", "victorious"))." ".esc_html($aFight['name2']);?>
                                <br>&nbsp;
                                <input type="radio" class="fightID" value="<?php echo esc_attr($aFight['fighterID2']);?>" name="winner<?php echo esc_attr($aFight['fightID']);?>" data-fightid="<?php echo esc_attr($aFight['fightID']);?>" <?php if($aFight['winnerID'] == $aFight['fighterID2']):?>checked="checked"<?php endif;?> <?php if($aFight['started'] == 1):?>disabled="true"<?php endif;?>>
                            </label>
                        </td>
                        ...
                        <td style="text-align:center;vertical-align: middle">
                            <?php if($aMethods != null):?>
                                <select onchange="checkMethod(this.value,<?php echo esc_attr($aFight['fightID']);?>)" class="form-control method" data-id="<?php echo esc_attr($aFight['fightID']);?>" id="method<?php echo esc_html($aFight['fightID']);?>" name="method<?php echo esc_html($aFight['fightID']);?>" style="width:205px" <?php if($aFight['started'] == 1):?>disabled="true"<?php endif;?>>
                                    <option value="-1">-- Select Method --</option>
                                    <?php foreach($aMethods as $aMethod):?>
                                    <option value="<?php echo esc_attr($aMethod["methodID"]);?>" <?php if($aFight['methodID'] == $aMethod["methodID"]):?>selected="true"<?php endif;?>>
                                        <?php echo esc_html($aMethod["description"]);?>
                            ...
                            <?php if(!empty($aMinutes)):?>
                                <br>
                                <br>
                                <select onchange="checkMinute(this.value,<?php echo esc_attr($aFight['fightID']);?>)" class="form-control minute" data-id="<?php echo esc_attr($aFight['fightID']);?>" id="minute<?php echo esc_html($aFight['fightID']);?>" name="minute<?php echo esc_html($aFight['fightID']);?>" style="width:205px" <?php if($aFight['started'] == 1):?>disabled="true"<?php endif;?>>
                                    <option value="-1">-- Select Minute --</option>
                                    <?php foreach($aMinutes as $aMinute):?>
                                    <option value="<?php echo esc_attr($aMinute["minuteID"]);?>" <?php if($aFight['minuteID'] == $aMinute["minuteID"]):?>selected="true"<?php endif;?>>
                                        <?php echo esc_html($aMinute["description"]);?>
