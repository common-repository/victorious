<?php
class VIC_MyUpcomingEntriesController
{
	...
	{       
        add_action('wp_enqueue_scripts', array('VIC_MyUpcomingEntriesController', 'theme_name_scripts'));
        add_filter('the_content', array('VIC_MyUpcomingEntriesController', 'addContent'));
	}
    ...
    public static function theme_name_scripts()
    {
        ...
        wp_enqueue_script('victorious.js', VICTORIOUS__PLUGIN_URL_JS.'global.js');
    ...
    public static function addContent()
    {
        ...
        $leagues = self::$victorious->getUpcomingEntries();
        $leagues = self::$victorious->parseLeagueData($leagues);
        include VICTORIOUS__PLUGIN_DIR_VIEW.'myupcomingentries.php';
    }
}
?>